...
//        }));
    ...
    /* if want both the available storage visivle send 1 in layoutVisibilityFlag
     *
      *
    ...
    private void dispLocalStorages(final Context mContext , int layoutVisibilityFlag )
    {
